...
var OrbitControls = function ( object, domElement ) {
	...
	this.setOrientation = function ( controls ) {
		...
		this.spherical2.setFromVector3( this.lookDirection );

		// this.lat = 90 - MathUtils.radToDeg( spherical2.phi );
		// this.lon = MathUtils.radToDeg( spherical2.theta );
		var targetPosition = new Vector3();

		targetPosition.setFromSphericalCoords( 1, this.spherical2.phi, this.spherical2.theta ).add( scope.object.position );
	...
	this.update = function () {
		...
		return function update() {
			...
			//my addition
			// let newTarget = position.copy( scope.target ).add( offset );
			// scope.object.lookAt( newTarget );
