...
export const HangarHelp = {
    ...
    size: "full",
    content:
        (<div><p>Thanks for joining in, having a look, and making your own galleries!</p>
            ...
            <p>I've been encouraged by the enthusiastic expression of interest from early users. People have come to me with many ideas for applications of the idea I'd never thought of, including:</p>
            <ul>
                ...
                <li>Teachers like this way of saving and disoplaying students' work</li>
                <li>Parents enjoy Galleries to show off their children's art to other parents and family</li>
            ...
            <p>Hangar, if that's what it is to be called, will always be mainly free.</p>

            <Title level={4}>Roadmap</Title>
            <ul>
                <li>Fix the big bugs - let me know the buggiest ones, please</li>
            </ul>
            <p>These are the features we're moving to next but am keen to hear what would make this work better for you</p>
            <ul>
