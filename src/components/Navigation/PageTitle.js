    ...
    return (
        <Row className={rowClass}>
            <Col span={24} style={{ textAlign: "center" }}>
                    {props.title ? <Title level={2} style={titleStyle} className="page-title-2"><div ref={measureRef}><span onClick={props.titleClickHandler}>{props.title}</span>{props.children}</div></Title> : <div className="title-logo-holder"><img src={logoSrc} className="title-logo" alt="hangar logo" style={{ marginTop: -4 }} /></div>}
