...
class WallEntity extends Component {
  ...
  setupControls() {
    ...
    this.gui.add(controls, "intensity", 0, 5).onChange(e => {
      this.spotLight.intensity = e;
    });
    this.gui.add(controls, "penumbra", 1, 1).onChange(e => {
      this.spotLight.penumbra = e;
    });

    this.gui.add(controls, "distance", 0, 200).onChange(e => {
      this.spotLight.distance = e;
    });

    this.gui.add(controls, "angle", 0.4, 1).onChange(e => {
